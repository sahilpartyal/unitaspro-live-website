...
const PROCESS = [
  { num: "01", Icon: Search,    title: "Discovery Call",     desc: "Free 30-min call. We map your workflow, pain points, and technical requirements — no jargon, no pressure.",                        color: "#7C3AED", bg: "#F5F3FF" },
  { num: "02", Icon: Layers,    title: "Architecture Plan",  desc: "System design, database schema, and API specs fully documented and agreed before development starts.",                             color: "#2563EB", bg: "#EFF6FF" },
  { num: "03", Icon: Code2,     title: "Build & Test",       desc: "Weekly sprint demos so you always see progress. CI/CD and automated tests run on every commit.",                                  color: "#059669", bg: "#ECFDF5" },
  { num: "04", Icon: Zap,       title: "Deploy & Support",   desc: "Cloud deployment, handover documentation, and 30 days free post-launch support included.",                                       color: "#D97706", bg: "#FFFBEB" },
];
      ...
      <section className="relative py-14 lg:py-24 overflow-hidden">
        ...
        <div className="container-main">
          <motion.p {...fadeUp()} className="text-sm text-[#6B7180] mb-6 flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-sm bg-[#0D0D1A] inline-block"/>
            Built with tools that power the fastest software on the web
          </motion.p>
            ...
            <motion.div {...fadeUp()} className="relative lg:sticky lg:top-28">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[11px] text-[#9CA3AF]">On time, every sprint</div>
                </div>
              </motion.div>
            </motion.div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item.stat} className="flex items-center gap-3 text-sm">
                      <span className="font-black shrink-0" style={{ color: "#7C3AED", letterSpacing: "-0.03em" }}>{item.stat}</span>
      ...
      <section className="bg-[#F7F8FC] py-20 lg:py-28" id="process">
        <div className="container-main">
          ...
          <motion.h2 {...fadeUp(0.05)} className="max-w-xl mb-14"
            ...
            <span className="font-semibold text-[#0D0D1A]">production in 8 weeks</span>
          </motion.h2>
