...
import {
  Hotel, Calendar, Star,
  MapPin, Bell, Users, BarChart3, CreditCard, Utensils, Shield, MessageSquare, Zap,
  PhoneCall, FileText, Layers, Rocket,
  Smartphone, Globe, Code2, BookOpen, HeadphonesIcon,
  Building2, UtensilsCrossed, Wine, Palmtree,
} from "lucide-react";
...
const data: IndustryPageData = {
  ...
  deliverables: {
    ...
    items: [
      ...
      { icon: BarChart3,      title: "Web Admin Dashboard",        desc: "Browser-based operations hub for property managers, chefs, and finance teams." },
  ...
  /* Comparison */
  comparison: {
    heading: "Why build custom instead of using off-the-shelf hospitality software?",
    cols: ["Custom Build", "OTA Platform", "Generic PMS"],
    rows: [
      { feature: "Branded entirely as your property",        custom: true,       alt1: false,       alt2: false      },
      { feature: "You own the source code",                  custom: true,       alt1: false,       alt2: false      },
      { feature: "Zero per-booking commission fees",         custom: true,       alt1: false,       alt2: true       },
      { feature: "Custom booking flow & guest experience",   custom: true,       alt1: "Limited",   alt2: "Limited"  },
      { feature: "Multi-property & multi-outlet support",    custom: true,       alt1: false,       alt2: "Limited"  },
      { feature: "Your own guest data — no shared pool",     custom: true,       alt1: false,       alt2: false      },
      { feature: "Integrates with your POS & channel manager", custom: true,     alt1: "Limited",   alt2: "Limited"  },
  ...
  process: [
    { num: "01", icon: PhoneCall, title: "Discovery Call",   desc: "We map your property types, current tools, and guest journey in a 30-minute call before writing a line of code." },
    ...
    { num: "03", icon: Layers,    title: "Design & Build",   desc: "Weekly demos on a shared staging environment. Real working software every sprint — no surprises at go-live." },
    { num: "04", icon: Rocket,    title: "Launch & Support", desc: "Full deployment with staff training. 30 days dedicated post-launch support for a smooth go-live." },
  ],
